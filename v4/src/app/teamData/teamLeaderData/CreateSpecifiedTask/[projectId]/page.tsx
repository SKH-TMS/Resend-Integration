  ...
  return (
    <div>
      <div className="p-6 relative">
        ...
        <div className="mt-4 p-4 border rounded-lg shadow-md text-black border-gray-200  bg-[#ecfbf4] ">
          ...
          <form>
            <div className="mb-4">
              <input
                ...
                className="w-full p-3 border rounded-md focus:ring-2 focus:ring-[#2c3532]"
              />
            </div>
            <div className="mb-4">
              <textarea
