...
// Interface for fetched user data (ensure it includes UserId)
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-200 mb-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form
            ...
            className="bg-white shadow-lg rounded-lg p-6 border border-gray-200 space-y-5"
          >
